import share from './index.module.scss'
import { Link } from 'react-router-dom'

function index({info}) {
  return (
    <div className={`d-flex justify-content-start align-items-center ${share.parent}`}>
      <div className='d-flex justify-content-start align-items-center'>
        <div style={{fontSize:'18px'}}>
          <b>Share on:</b>
        </div>
        <Link to="/#" className='ps-4 link-light'>
        ...
        <Link to="/#" className='ps-4 link-light'>
          <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="bi bi-slack" viewBox="0 0 16 16">
      ...
      <div className={`ms-5 ${share.shareInfo}`}>
        {info}
      </div>
    </div>
  )
